...
class LibDateTestCase(unittest.TestCase):
   ...
   #--------------------------------------------------------------------------
    ...
    def test_dates(self):
        ...
        dates1 = [datetime.date(2018,1,1), datetime.date(2018,1,2),
    ...
    def test_enumdates(self):
        ...
        dates1 = [EnumDate(idx=0, date=datetime.date(2018,1,1)),
        ...
        dates2 = [EnumDate(idx=0, date=datetime.date(2018,1,1)),
