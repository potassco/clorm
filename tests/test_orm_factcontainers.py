...
class FactMapTestCase(unittest.TestCase):
    ...
    def test_set_ops(self):
        def fm2set(fm): return set(fm.factset)
        Afact = self.Afact
        ...
        fm2.add_facts([af3])
        r=fm1.union(fm1); self.assertEqual(fm2set(r),set([af1,af2]))
        r=fm1.union(fm2); self.assertEqual(fm2set(r),set([af1,af2,af3]))
        r=fm1.union(fm2,[af4]); self.assertEqual(fm2set(r),set([af1,af2,af3,af4]))
        ...
        r=fm1.intersection(fm1); self.assertEqual(fm2set(r),set(fm2set(fm1)))

        r=fm1.intersection(fm2); self.assertEqual(fm2set(r),set([af2]))
        r=fm1.intersection(fm2,[af2,af3,af4]); self.assertEqual(fm2set(r),set([af2]))
        r=fm1.intersection(fm2,[af3,af4]); self.assertEqual(fm2set(r),set())
        ...
        fm1.add_facts([af1,af2])
        fm2.add_facts([af2,af3])
        r=fm1.difference(fm1); self.assertEqual(fm2set(r),set([]))
        r=fm1.difference([af1]); self.assertEqual(fm2set(r),set([af2]))
        r=fm1.difference(fm2); self.assertEqual(fm2set(r), set([af1]))
        ...
        fm1.add_facts([af1,af2])
        fm2.add_facts([af2,af3])
        r=fm1.symmetric_difference(fm1); self.assertEqual(fm2set(r),set())
        r=fm1.symmetric_difference(fm2); self.assertEqual(fm2set(r),set([af1,af3]))
    ...
    def test_factmap_copy(self):
        ...
        self.assertTrue(not fm1.path2factindex[hp(Afact.anum)] \
                        is fm2.path2factindex[hp(Afact.anum)])
